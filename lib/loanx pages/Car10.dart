...
class Car10 extends StatefulWidget {
  const Car10({super.key});

  @override
  State<Car10> createState() => _Car10State();
}

class _Car10State extends State<Car10> {
  double p = 7500000;
  double m = 4000;
  late double w=0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Suzuki Wagon R 2017", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Suzuki Wagon R 2017 Specifications", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold,color: Color(0xFF97C7E8)),textAlign: TextAlign.left,),
            SizedBox(height: 10),
