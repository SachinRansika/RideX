...
import '../widgets/LineAxio3.dart';

class Car16 extends StatefulWidget {
  const Car16({super.key});

  @override
  State<Car16> createState() => _Car16State();
}

class _Car16State extends State<Car16> {
  late double w=0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Toyota Axio 2018", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Toyota Axio 2018 Specifications", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold,color: Color(0xFF97C7E8)),textAlign: TextAlign.left,),
            SizedBox(height: 10),
