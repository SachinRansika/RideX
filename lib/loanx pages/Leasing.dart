...
class _LeasingState extends State<Leasing> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Leasing Companies", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
      ),
      body: SingleChildScrollView(
        padding: EdgeInsets.all(16.0),
        child: Column(
          children: [
            Center(child: Text("Company A", style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold),)),
            SizedBox(height: 20),
            Center(
              child: Text("If you're using “Leasing company A” as a placeholder, one of the most prominent private banking services in Sri Lanka is offered by Bank A, known for its exclusive and personalized wealth management under the Private Banking Centre.", style: TextStyle(
                fontSize: 20,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 30),
                  Text(
                      "Yearly Interest Rate - 13%", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: Colors.black)
                  ),
                  Text(
                      "Monthly Interest Rate - 0.0108%", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: Colors.black)
                  ),
                ],
              ),
            ...
            //bank B
            SizedBox(height: 70),
            Center(child: Text("Company B", style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold),)),
            SizedBox(height: 20),
            Center(
              child: Text("If you're using “Leasing company B” as a placeholder, one of the most prominent private banking services in Sri Lanka is offered by Bank B, known for its exclusive and personalized wealth management under the Private Banking Centre.", style: TextStyle(
                fontSize: 20,
              ),textAlign: TextAlign.center,),
            ),
            SizedBox(height: 20),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 30),
                  Text(
                      "Yearly Interest Rate - 16%", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: Colors.black)
                  ),
                  Text(
                      "Monthly Interest Rate - 0.0134%", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold,color: Colors.black)
                  ),
                ],
              ),
            ...
            //bank c
            SizedBox(height: 70),
            Center(child: Text("Company C", style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold),)),
            SizedBox(height: 20),
            Center(
              child: Text("If you're using “Leasing company C” as a placeholder, one of the most prominent private banking services in Sri Lanka is offered by Bank C, known for its exclusive and personalized wealth management under the Private Banking Centre.", style: TextStyle(
                fontSize: 20,
              ),textAlign: TextAlign.center,),
            ),
            SizedBox(height: 20),
