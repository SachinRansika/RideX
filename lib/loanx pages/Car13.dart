...
import '../widgets/LineVitz2.dart';


class Car13 extends StatefulWidget {
  const Car13({super.key});

  @override
  State<Car13> createState() => _Car13State();
}

class _Car13State extends State<Car13> {
  double p = 7500000;
  double m = 4000;
  late double w=0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Toyota Vitz 2018", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Toyota Vitz 2018 Specifications", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold,color: Color(0xFF97C7E8)),textAlign: TextAlign.left,),
            SizedBox(height: 10),
